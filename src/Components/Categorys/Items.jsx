...
const Items = ({ selectedSub, }) => {
    ...
    const handleShowMore = () => {
        if (visibleCount < selectedSub.items.length) {
        ...
        <div className="container mx-auto px-8 py-10">
            ...
            <div className="mb-10 max-w-2xl container mx-auto">
                ...
                <p className="text-[16px] text-center text-gray-500">
                    See all products in this category. You can choose your preferred products and get special offers.
                </p>
            </div>

            {/* Product Cards */}
            <div className="flex flex-wrap justify-center gap-8">
                {selectedSub.items.slice(0, visibleCount).map(item => {
                                    ...
                                    <div className="flex">
                                        {Array.from({ length: 5 }, (_, i) => {
                                            if (i < fullStars) return <FaStar key={i} className="text-yellow-400" />;
                                                ...
                                                return <FaStarHalf key={i} className="text-yellow-400" />;
