                    ...
                    ">
                                {
                                    categorys.map((category) => (
                                        <div key={category.id} className="border  hover:bg-[#f9ecda] border-gray-200 p-4 rounded-lg shadow space-y-1 flex items-center gap-6 transition-all duration-500 hover:shadow-xl  ">
